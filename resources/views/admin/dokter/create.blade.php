                    ...
                    <form action="{{ route('admin.dokter.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                <i class="bi bi-info-circle"></i> Pastikan User yang dipilih memiliki role <b>Dokter</b>.
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Bidang / Spesialis <span class="text-danger">*</span></label>
                                        <input type="text" name="bidang_dokter" class="form-control" placeholder="Contoh: Dokter Umum / Spesialis Bedah">
                                    </div>
